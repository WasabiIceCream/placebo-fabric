...
public abstract class PlaceboContainerMenu extends AbstractContainerMenu implements QuickMoveMenu {
    ...
    /**
     * Variant of {@link AbstractContainerMenu#clearContainer(Player, Container)} for an {@link InternalItemHandler}.
     * <p>
     * Port note (NeoForge -> Fabric): the original takes a NeoForge {@code transfer}
     * {@code ResourceHandler<ItemResource>}; {@link InternalItemHandler} now implements
     * vanilla {@link Container} directly, so this just delegates to the vanilla overload.
     */
    protected void clearContainer(Player player, InternalItemHandler inv) {
        super.clearContainer(player, inv.asContainer());
    }
